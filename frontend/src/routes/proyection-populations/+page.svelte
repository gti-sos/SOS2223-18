<script>
   ...
   import { onMount } from "svelte";
    ...
    <Pagination style="text-align: center; display: flex; justify-content: center; flex-direction: row; gap: 15px;" ariaLabel="Page navigation example">
        ...
        <PaginationItem>
            <PaginationLink on:click={() => getPaginacion(9,20)}>2</PaginationLink>
        </PaginationItem>
        <PaginationItem>
            <PaginationLink on:click={() => getPaginacion(20,29)}>3</PaginationLink>
        </PaginationItem>
        <PaginationItem>
            <PaginationLink on:click={() => getPaginacion(20,29)} last/>
        </PaginationItem>
    </Pagination>
